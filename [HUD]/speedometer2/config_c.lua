...
Config['useKM'] = true; -- Set true to use KM/H unit

Config['seatbeltInput'] = 311; -- Toggle seatbelt on/off with K
...
Config['cruiseInput'] = 29; -- Toggle cruise on/off with CAPSLOCK or A button (controller)
