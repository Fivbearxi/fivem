Locales['fr'] = {
  ...
  -- Death
  ['respawn_available_in'] = 'réanimation possible dans ~p~%s minutes %s secondes~s~',
  ['respawn_bleedout_in'] = 'réanimation dans ~p~%s minutes %s secondes~s~\n',
  ['respawn_bleedout_prompt'] = 'maintenez [~p~E~s~] pour être réanimé',
  ['respawn_bleedout_fine'] = 'maintenez [~p~E~s~] pour être réanimé pour ~g~$%s~s~',
  ['respawn_bleedout_fine_msg'] = 'vous avez payé ~r~$%s~s~ pour être réanimer.',
  ['distress_send'] = 'appuyez sur [~p~G~s~] pour envoyer un signal de détresse',
  ...
  ['not_enough_medikit'] = 'vous n\'avez pas de ~p~kit de soin~s~.',
  ['not_enough_bandage'] = 'vous n\'avez pas de ~p~pandage~s~.',
